...
func TodoIndex(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewEncoder(w).Encode(repo.Todos); err != nil {
		panic(err)
	}
}
...
func TodoShow(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewEncoder(w).Encode(cerror.JsonErr{Code: http.StatusNotFound, Text: "Not Found"}); err != nil {
		panic(err)
	}
